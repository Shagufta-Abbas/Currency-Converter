...
let apiLink =
"https://v6.exchangerate-api.com/v6/988482f59646fe2ddf854298/latest/PKR";
...
let cnv =
`https://v6.exchangerate-api.com/v6/988482f59646fe2ddf854298/pair/${firstCountry.name}/${secondCountry.name}`;
